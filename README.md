...
本项目希望佛教典籍与相关知识能够被更多人免费接触和学习。个人学习、研究、教学、公益传播、免费推广和其他非商业使用均受到欢迎，也欢迎 Fork、修改代码和提交贡献。

如果你计划基于本项目向用户收费、获取商业收益、提供商业服务、部署到企业生产环境或进行其他预期商业应用，请先通过 `admin@guanzizai.org` 联系我们确认授权方式。我们希望免费传播保持自由，也希望收费或营利用途事先说明并取得同意。公益、小规模或有助于典籍传播的项目，可以申请免费或优惠的商业授权。
...
本项目不主张对依法属于公有领域的佛教经典本身享有独占权。商业授权要求针对的是本项目源码、原创设计、品牌和随仓库发布的自有材料，不限制任何人依照法律独立获取、整理或传播公有领域经典。
